...
int main()
{
	...
	cout << " structure elemts temp:  " << sin(pdat->temp) << endl;
	cout << "Year:   " << pdat->year << endl;
	cout << "month:   " << pdat->year << endl;
	cout << "Year:   " << pdat->year << endl;
	...
	cout << "pdat" << pdat->year << " " << pdat->month << " " << pdat->day << " " << pdat->daynum << " " << retval << " " << pdat->amass << " " << pdat->ampress << endl;
